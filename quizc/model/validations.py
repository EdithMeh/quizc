...
class MaxLengthValidator(object):
    MESSAGE = "The value should be only uppercase text"
...
class UpperCaseValidator(object):
    MESSAGE = "The value length must be max than {max_length}"
...
class ValidatorType(Enum):
    ...
    MAN_LENGTH = (5, MaxLengthValidator())
    UPPER = (5, UpperCaseValidator())
    MAX = (6, MaxValidator())
